<template>
  ...
  {{ aVariable }}
  x
  {{ bVariable }} = {{ calcResult }}
  <hr />

  <div v-for="(char, idx) in charGroup" :key="idx">
...
export default {
  ...
  data() {
    return {
      ...
      charGroup: [],
      userList: [
        // array , list => key 가 없다 // inerable 하다.
        {
          // object , map => key가 있다. // interable 하지 않다.
          id: 1,
          name: "Leanne Graham",
          username: "Bret",
  ...
  computed: {
    ...
    calcResult() {
      let result = this.aVariable * this.bVariable;
      return result;
    },
  },
};
