<template>
  ...
  <div v-else-if="filteredList.length < 1" class="loader">
    ...
    <router-link
      ...
      :to="{
        name: 'memo',
        params: { userId: this.$route.params.userId, titleId: backPage },
      }"
    >{{refresh()}}돌아가기</router-link>
  </div>
  ...
  <div v-else class="memo">
    ...
    <div class="buttons" @click="refresh()">
      <router-link
        ...
        :to="{
          name: 'memo',
          params: { userId: this.$route.params.userId, titleId: prevPage },
        }"
        >prev</router-link
      >
      <router-link
        ...
        :to="{
          name: 'memo',
          params: { userId: this.$route.params.userId, titleId: nextPage },
        }"
        >next</router-link
      >
    </div>
